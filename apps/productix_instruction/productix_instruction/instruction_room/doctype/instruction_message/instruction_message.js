frappe.ui.form.on('Instruction Message', {
    refresh: function(frm) {
        ...
        if (frappe.user.has_role(['Factory Admin', 'Productix Admin', 'Productix Assistant Admin', 'System Manager', 'Administrator'])) {
            frm.add_custom_button(__('🗑 Clear All Messages'), function() {
                frappe.confirm(
                    ...
                    () => frappe.call({
                        method: 'productix_instruction.instruction_room.doctype.instruction_message.instruction_message.clear_all_messages',
        ...
        frappe.call({
            method: 'productix_instruction.instruction_room.doctype.instruction_message.instruction_message.mark_all_read',
        });
    },
