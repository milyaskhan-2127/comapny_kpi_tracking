...
def _check_negative_trend(kpi, department, settings):
    from productix_kpi.kpi_tracking.services.analytics import calculate_trend
...
def send_missing_data_reminders(department=None, period=None, frequency="Monthly", message=None):
    ...
    from productix_kpi.kpi_tracking.api.data_entry import get_data_entry_monitoring
