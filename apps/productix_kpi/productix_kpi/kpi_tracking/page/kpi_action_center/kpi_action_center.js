...
function load_actions(page) {
    ...
    frappe.xcall("productix_kpi.kpi_tracking.api.dashboard.get_action_center").then((data) => {
...
function render_actions(page, data) {
    ...
    page.main.find(".ack-btn").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.services.alert_engine.acknowledge_alert", {
            alert_name: name,
        }).then(() => {
    ...
    page.main.find("#btn-ack-all-alerts").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.services.alert_engine.acknowledge_all_alerts").then((res) => {
    ...
    page.main.find("#btn-resolve-all-alerts").on("click", function () {
        frappe.confirm("Mark all active alerts as Resolved?", function () {
            frappe.xcall("productix_kpi.kpi_tracking.services.alert_engine.resolve_all_alerts").then((res) => {
    ...
    page.main.find(".resolve-btn").on("click", function () {
        const name = $(this).data("name");
        frappe.xcall("productix_kpi.kpi_tracking.services.alert_engine.resolve_alert", {
            alert_name: name,
        }).then(() => {
    ...
    page.main.find("#remind-all-missing-btn").on("click", function () {
        frappe.confirm("Send notifications to all employees in departments with missing entries?", function () {
            frappe.xcall("productix_kpi.kpi_tracking.services.alert_engine.send_missing_data_reminders").then((res) => {
