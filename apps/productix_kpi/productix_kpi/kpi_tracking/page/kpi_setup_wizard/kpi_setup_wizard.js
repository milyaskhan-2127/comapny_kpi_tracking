...
function load_wizard(page) {
    ...
    frappe.xcall("productix_kpi.kpi_tracking.api.setup.get_setup_status").then((data) => {
...
function render_wizard(page, data) {
    ...
    page.main.find("#btn-quick-setup").on("click", function () {
        frappe.confirm(
            ...
            () => {
                ...
                frappe.xcall("productix_kpi.kpi_tracking.api.setup.one_click_quick_setup", {
                    company_name: comp,
                    currency: cur,
                }).then((r) => {
    ...
    page.main.find("#btn-save-company").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.api.setup.setup_company", {
    ...
    page.main.find("#btn-add-single-dept").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.api.setup.create_or_update_department", {
    ...
    page.main.find("#btn-create-depts").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.api.setup.setup_departments", { departments: deptPayload }).then((r) => {
    ...
    page.main.find("#btn-deploy-templates").on("click", function () {
        ...
        frappe.xcall("productix_kpi.kpi_tracking.api.setup.apply_all_default_templates").then((r) => {
    ...
    page.main.find("#btn-finalize-setup").on("click", function () {
        frappe.xcall("productix_kpi.kpi_tracking.api.setup.complete_setup").then(() => {
