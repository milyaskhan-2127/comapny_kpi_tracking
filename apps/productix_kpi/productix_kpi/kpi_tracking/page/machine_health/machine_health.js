...
function load_machines_home(page) {
    frappe.call({
        method: 'productix_kpi.kpi_tracking.api.machine.get_machines',
        args: {},
        callback: function(r) {
            try {
...
function load_detail(page, machine_name) {
    ...
    `);
    frappe.call({
        method: 'productix_kpi.kpi_tracking.api.machine.get_machine_detail',
...
function open_reading_modal(page, detail) {
    ...
    const d = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'productix_kpi.kpi_tracking.api.machine.submit_machine_reading',
...
function open_create_machine_modal(page) {
    ...
    const d = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'productix_kpi.kpi_tracking.api.machine.create_machine',
                args: {
                    machine_name: name,
                    machine_code: code,
                    machine_type: mtype,
    ...
    frappe.call({
        method: 'productix_kpi.kpi_tracking.api.machine.get_machine_types',
        callback: function(r) {
...
function open_add_kpi_modal(page, machine_name) {
    ...
    const d = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: 'productix_kpi.kpi_tracking.api.machine.add_machine_kpi',
    ...
    frappe.call({
        method: 'productix_kpi.kpi_tracking.api.dashboard.get_kpi_options',
        callback: function(r) {
...
function remove_kpi(page, machine_name, kpi) {
    frappe.confirm(__('Remove this KPI from the machine?'), function() {
        frappe.call({
            method: 'productix_kpi.kpi_tracking.api.machine.remove_machine_kpi',
            args: { machine: machine_name, kpi: kpi },
            callback: function(r) {
                if (r.message && r.message.success) {
                    frappe.show_alert({ message: __(r.message.message), indicator: 'green' });
