...
def ask_ai(specialist_type, question, department=None, business_unit=None,
    ...
    from productix_kpi.kpi_tracking.services.groq_ai import get_ai_response, build_context_data
...
def get_suggestions(specialist_type, department=None):
    _require_admin()
    from productix_kpi.kpi_tracking.services.groq_ai import get_suggested_questions
...
def send_ai_alert(department, message, severity="Warning"):
    _require_admin()
    from productix_kpi.kpi_tracking.services.alert_engine import dispatch_ai_department_alert
...
def get_top_inefficiencies(department=None, limit=5):
    ...
    from productix_kpi.kpi_tracking.services.analytics import calculate_growth
