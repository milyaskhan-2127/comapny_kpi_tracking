...
def get_machine_detail(machine_name):
    ...
    from productix_kpi.kpi_tracking.services.machine_health import get_machine_health_summary
...
def get_company_machines_overview():
    from productix_kpi.kpi_tracking.security.permissions import is_kpi_admin, is_kpi_ceo, get_ceo_access
    if is_kpi_admin():
        pass
    elif is_kpi_ceo():
        ceo = get_ceo_access()
