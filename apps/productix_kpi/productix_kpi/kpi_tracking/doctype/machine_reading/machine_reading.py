...
class MachineReading(Document):
    ...
    def _calculate_health(self):
        from productix_kpi.kpi_tracking.services.machine_health import calculate_reading_health
    ...
    def _update_machine_health(self):
        from productix_kpi.kpi_tracking.services.machine_health import update_machine_health
