...
class ProductionOrder(Document):
    ...
    def start_production(self):
        ...
        from productix_recipe.recipe_management.utils.fefo_utils import consume_stock_fefo
...
def check_order_stock(recipe, quantity=1, order_extras=None):
    ...
    from productix_recipe.recipe_management.utils.fefo_utils import check_availability
