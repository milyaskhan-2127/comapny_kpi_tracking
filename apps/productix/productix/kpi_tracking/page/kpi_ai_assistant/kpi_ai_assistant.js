...
function load_suggestions(page) {
    frappe.xcall("productix.kpi_tracking.api.ai_assistant.get_suggestions", {
...
function send_question(page) {
    ...
    frappe.xcall("productix.kpi_tracking.api.ai_assistant.ask_ai", {
        specialist_type: page._specialist,
        question: question,
    ...
    frappe.xcall("productix.kpi_tracking.api.dashboard.get_user_context").then((ctx) => {
        ...
        const d = new frappe.ui.Dialog({
            ...
            primary_action: function (values) {
                ...
                frappe.xcall("productix.kpi_tracking.services.alert_engine.dispatch_ai_department_alert", {
